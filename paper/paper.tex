...
The latter formulation decomposes the kernel into separate ``parameter maps'', making relationships like the one between \verb|x| and \verb|mean(κ(x))| more explicit.
